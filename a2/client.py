...
def get_products():
    response = requests.get(f'http://{host}:5002/products')
...
def get_product(product_id):
    response = requests.get(f'http://{host}:5002/products/{product_id}')
    if response.status_code == 200:
        data = response.json()
...
def add_product(name):
    ...
    response = requests.post(f'http://{host}:5002/products', json=new_product)
    if response.status_code == 200:
        data = response.json()
...
def remove_product(product_id):
    response = requests.post(f'http://{host}:5002/products/{product_id}')
    if response.status_code == 200:
        data = response.json()
...
def remove_products():
    response = requests.post(f'http://{host}:5002/products/edit')
    if response.status_code == 200:
        data = response.json()
...
def get_products_in_cart(user_id):
    response = requests.get(f'http://{host}:5001/cart/{user_id}')
    if response.status_code == 200:
        data = response.json()
...
def add_product_to_cart(user_id, product_id):
    ...
    response = requests.post(f'http://{host}:5001/cart/{user_id}/add/{product_id}', json=product)
    if response.status_code == 200:
        data = response.json()
...
def remove_product_from_cart(user_id, product_id, quantity):
    ...
    response = requests.post(f'http://{host}:5001/cart/{user_id}/remove/{product_id}', json=quantity)
    if response.status_code == 200:
        data = response.json()
...
def add_user(username):
    ...
    response = requests.post(f'http://{host}:5001/users', json=new_user)
    if response.status_code == 200:
        data = response.json()
        print("User Added:")
        print(data)
